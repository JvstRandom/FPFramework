        ...
        <div class="page-content">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="main-profile ">
                <div class="row">
                  <div class="col-lg-4">
                    <img src="<?php echo base_url("assets/img/portfolio/app1.jpg"); ?>" alt="" style="border-radius: 23px;">
                  </div>
          ...
          <div class="gaming-library profile-library">
            <div class="col-lg-12">
              ...
              <div class="item">
                <ul>
                  <li><img src="<?php echo base_url("assets/img/portfolio/app1.jpg"); ?>" alt="" class="templatemo-item"></li>
