...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo base_url("assets-dash/vendor/bootstrap/css/bootstrap.min.css"); ?>">
    <link href="<?php echo base_url("assets-dash/vendor/fonts/circular-std/style.css"); ?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url("assets-dash/libs/css/style.css"); ?>">
    <link rel="stylesheet" href="<?php echo base_url("assets-dash/vendor/fonts/fontawesome/css/fontawesome-all.css"); ?>">
    <link rel="stylesheet" href="<?php echo base_url("assets-dash/vendor/charts/chartist-bundle/chartist.css"); ?>">
    <link rel="stylesheet" href="<?php echo base_url("assets-dash/vendor/charts/morris-bundle/morris.css"); ?>">
    <link rel="stylesheet" href="<?php echo base_url("assets-dash/vendor/fonts/material-design-iconic-font/css/materialdesignicons.min.css"); ?>">
    <link rel="stylesheet" href="<?php echo base_url("assets-dash/vendor/charts/c3charts/c3.css"); ?>">
    <link rel="stylesheet" href="<?php echo base_url("assets-dash/vendor/fonts/flag-icon-css/flag-icon.min.css"); ?>">
...
<body>
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-1-2" class="collapse submenu" style="">
                                                <!-- <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="<?php echo base_url("views/Dashboard/dashboard_index.php"); ?>">E Commerce Dashboard</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="<?php echo base_url("views/Dashboard/product-list.php"); ?>">Product List</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="<?php echo base_url("views/Dashboard/product-single.php"); ?>">Product Single</a>
                                                    </li>
                                                    <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo base_url("views/Dashboard/product-single.php"); ?>">product</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
    ...
    <!-- Optional JavaScript -->
    <!-- jquery 3.3.1 -->
    <script src="<?php echo base_url("assets-dash/vendor/jquery/jquery-3.3.1.min.js"); ?>"></script>
    <!-- bootstap bundle js -->
    <script src="<?php echo base_url("assets-dash/vendor/bootstrap/js/bootstrap.bundle.js"); ?>"></script>
    <!-- slimscroll js -->
    <script src="<?php echo base_url("assets-dash/vendor/slimscroll/jquery.slimscroll.js"); ?>"></script>
    <!-- main js -->
    <script src="<?php echo base_url("assets-dash/libs/js/main-js.js"); ?>"></script>
    <!-- chart chartist js -->
    <script src="<?php echo base_url("assets-dash/vendor/charts/chartist-bundle/chartist.min.js"); ?>"></script>
    <!-- sparkline js -->
    <script src="<?php echo base_url("assets-dash/vendor/charts/sparkline/jquery.sparkline.js"); ?>"></script>
    <!-- morris js -->
    <script src="<?php echo base_url("assets-dash/vendor/charts/morris-bundle/raphael.min.js"); ?>"></script>
    <script src="<?php echo base_url("assets-dash/vendor/charts/morris-bundle/morris.js"); ?>"></script>
    <!-- chart c3 js -->
    <script src="<?php echo base_url("assets-dash/vendor/charts/c3charts/c3.min.js"); ?>"></script>
    <script src="<?php echo base_url("assets-dash/vendor/charts/c3charts/d3-5.4.0.min.js"); ?>"></script>
    <script src="<?php echo base_url("assets-dash/vendor/charts/c3charts/C3chartjs.js"); ?>"></script>
    <script src="<?php echo base_url("assets-dash/libs/js/dashboard-ecommerce.js"); ?>"></script>
</body>
